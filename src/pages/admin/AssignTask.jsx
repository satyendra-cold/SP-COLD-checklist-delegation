...
export default function AssignTask() {
  ...
  const fetchMasterSheetOptions = async () => {
    try {
      const masterSheetId = "1iBYzalMyBk5ZaUv7U_2OxY2iZsPh7cMGXVwhPeC_-Fg";
  ...
  const getLastTaskId = async (sheetName) => {
    try {
      const url = `https://docs.google.com/spreadsheets/d/1iBYzalMyBk5ZaUv7U_2OxY2iZsPh7cMGXVwhPeC_-Fg/gviz/tq?tqx=out:json&sheet=${encodeURIComponent(
        sheetName
      )}`;
  ...
  const fetchWorkingDays = async () => {
    try {
      const sheetId = "1iBYzalMyBk5ZaUv7U_2OxY2iZsPh7cMGXVwhPeC_-Fg";
