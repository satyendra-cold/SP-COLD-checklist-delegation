...
const LoginPage = () => {
  ...
  useEffect(() => {
    const fetchMasterData = async () => {
      const SCRIPT_URL = "https://script.google.com/macros/s/AKfycbx426p_teOMVFcMG22RngcroTClA1vB2Z4M1CN9AjAhChiyjVPCO-5wIPM7m6cQHMgx/exec"

      try {
        setIsDataLoading(true)

        // Get the spreadsheet ID from your Apps Script
        const SPREADSHEET_ID = "1iBYzalMyBk5ZaUv7U_2OxY2iZsPh7cMGXVwhPeC_-Fg"
